...
@media only screen and (max-width: 600px) {
  #slider_<?php echo $sliderrandomid; ?>, #slider_<?php echo $sliderrandomid; ?> .slider > *, #slider_<?php echo $sliderrandomid; ?> .banner-bg{max-height:<?php echo $height*0.8; ?>px!important; height:<?php echo $height*0.8; ?>px!important;}
}
@media only screen and (max-width: 500px) {
  ...
  #slider_<?php echo $sliderrandomid; ?>, #slider_<?php echo $sliderrandomid; ?> .slider > *, #slider_<?php echo $sliderrandomid; ?> .banner-bg{max-height:<?php echo $height*0.7; ?>px!important;  height:<?php echo $height*0.7; ?>px!important;}
}
@media only screen and (max-width: 400px) {
  ...
  #slider_<?php echo $sliderrandomid; ?>, #slider_<?php echo $sliderrandomid; ?> .slider > *, #slider_<?php echo $sliderrandomid; ?> .banner-bg{max-height:<?php echo $height*0.6; ?>px!important;  height:<?php echo $height*0.6; ?>px!important;}
}
</style>
<?php } ?>
