            ...
            menu: [
                ...
                },
                {
                    ...
                    menu: [
                                ...
                                {
                                    text: 'Simple slider (Responsive height)',
                                    value: '[ux_slider timer="4500" height="500px" arrows="true" bullets="true" auto_slide="true" nav_color="dark"]<br> Insert slides here (UX Banner or Sections) <br>[/ux_slider]',
                                    onclick: function(e) {
                                        e.stopPropagation();
                                        editor.insertContent(this.value());
                                    }       
                ...
                },
                {
                    ...
                    menu: [
                        ...
                        {
                            text: 'Text Block',
                            value: '[ux_text text_pos="center" height="auto" text_align="center" text_color="dark" padding="30px"] Text [/ux_text]',
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
                        ...
                        {
                            text: 'Scroll To Link',
                            value: '[scroll_to link="#scrolltothis" bullet="true" bullet_title="Scroll to This"]',
                            onclick: function(e) {
                                e.stopPropagation();
                                editor.insertContent(this.value());
                            }       
...
var uxAnimations = [
    ...
    {text: 'Flip In Y', value: 'animate="flipInX"'},
]
